...
class Code128:
      ...
      for c in range(len(code)):
          ...
          if len(code[c:]) >=4 and code[c:c+4].isdigit() and current_charset!=self.CharSetC or \
             ...
             if current_charset!=self.CharSetC:
                 ...
                 pos+=1
          elif self.CharSetB.__contains__(code[c]) and current_charset!=self.CharSetB and \
               not(self.CharSetA.__contains__(code[c]) and current_charset==self.CharSetA):
             ...
             pos+=1
          elif self.CharSetA.__contains__(code[c]) and current_charset!=self.CharSetA and \
               not(self.CharSetB.__contains__(code[c]) and current_charset==self.CharSetB):
   ...
   def getImage(self, value, height = 100, extension = "PNG", path = ""):
      ...
      # Draw text
      #draw.text((position, height-9), value, font=font, fill=0)
